...
function createInfo() {
	var newInfoBox = '<div class="infobox-container"><input type="button" class="remove-infoBox" value="&#10006"><textarea class="content" rows="10" cols="50"></textarea></div><br>';
...
$(document).on('click', '.preview-btn' , function() {
	var currentSession = $('#website-container').html();
