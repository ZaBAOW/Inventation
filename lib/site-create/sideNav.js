...
function createCountdown(){
	var newCountDown = '<div class="countdown-container"><input type="button" class="remove-countdown" value="&#10006"><form action="/action_patge.php">Event (date and time):<input type="datetime-local" name="eventDay"><input onsubmit="return setCountDown()" type="submit" name="Send"></form><p id="countdown"></p></div>';
...
function returnHome () {
	window.location.replace("https://zabaow.github.io/Inventation/lib/site-create/index.html");
}
