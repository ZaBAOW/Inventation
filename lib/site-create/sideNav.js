...
function saveSession() {
	sessionStorage.setItem('session', document);
}

function restoreSession() {
	if(sessionStorage.getItem('session')){
		document.value = sessionStorage.getItem('session');
	}
}